...
app = FastAPI(title="FastAPI — Day 1 & 2 Assignments")
...
def home():
    return {
        "message": "Welcome to my FastAPI Assignment!", 
        "instruction": "Add /docs to the URL to see the Swagger UI testing page or /products to see the list."
    }

# ==========================================
# INITIAL DATA (Matched exactly to your screenshot)
# ==========================================
products = [
...
# --- Q3: Accept Customer Feedback (Pydantic + POST) ---
